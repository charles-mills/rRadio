local stations = {
    ...
    {name = "Радио Брест 104.8 Fm", url = "http://178.124.131.35:8012/trkbrest"},
    ...
    {name = "Радыё Свабода. Навіны Беларусі", url = "https://n0b.radiojar.com/zv9u3eapn3quv?rj-ttl=5&rj-tok=AAABkZAOJL0ADG2_AxlCfYfEWQ"},
