local stations = {
    ...
    {name = "105.4 Cascais - O Rock da Linha", url = "https://play.radioregional.pt:8220/stream/2/;;/stream.mp3"},
    ...
    {name = "92.2 KFM", url = "https://s9.yesstreaming.net:9012/stream"},
    ...
    {name = "Antena 1 (Portugal)", url = "http://streaming-live.rtp.pt/liveradio/antena180a/playlist.m3u8"},
    {name = "Antena 1 (Portugal)", url = "https://streaming-live.rtp.pt/liveradio/antena180a/playlist.m3u8"},
    {name = "Antena 1 (Portugal)", url = "https://streaming-live.rtp.pt/liveradio/antena180a/playlist.m3u8"},
    {name = "Antena 1 (Portugal)", url = "http://streaming-live-app.rtp.pt/liveradio/antena180a/playlist.m3u8"},
    ...
    {name = "Antena 2 (AAC)", url = "http://streaming-live-app.rtp.pt/liveradio/antena280a/playlist.m3u8"},
    ...
    {name = "Cascais FM 105.4", url = "https://play.radioregional.pt:8220/stream/2/;/stream.mp3"},
    {name = "cidade hiphop", url = "https://stream-hls.bauermedia.pt/cidhiphop.aac/playlist.m3u8"},
    {name = "Cidade_fm", url = "https://stream-hls.bauermedia.pt/cidade.aac/playlist.m3u8"},
    ...
    {name = "Estádio 96.2", url = "https://radios2.justweb.pt:8008/stream?type=http&nocache=65%20https://radios2.justweb.pt:8008/stream?type=http&nocache=65"},
    {name = "Estádio 96.2", url = "https://radios2.justweb.pt:8008/stream?type=http&nocache=65"},
    ...
    {name = "jovembsk", url = "https://stream-174.zeno.fm/ppgb4k7vhqztv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJwcGdiNGs3dmhxenR2IiwiaG9zdCI6InN0cmVhbS0xNzQuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6Ik1keklFQUhEUW02WHktMlRHaVJjMlEiLCJpYXQiOjE3MjQ2ODY2MjYsImV4cCI6MTcyNDY4NjY4Nn0.H37Fg0YHf8T9ySFQ9NigKWsqRztoQtnQeXRt1PJV_Ac"},
    ...
    {name = "JOVEMBSK MIX", url = "http://stream-175.zeno.fm/4nc1mzdp81xuv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiI0bmMxbXpkcDgxeHV2IiwiaG9zdCI6InN0cmVhbS0xNzUuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6IlFadmFQalV2Uml1NlRKSEhxdURKLWciLCJpYXQiOjE3MjQ2NDQwMzMsImV4cCI6MTcyNDY0NDA5M30.9R4UEF8PMoe4Jj0IE9ynjL1eABHPpcLOvwLbv5QGVMQ"},
    ...
    {name = "Oxigénio 102.6", url = "https://proic1.evspt.com/oxigenio_aac"},
    ...
    {name = "Posto Emissor do Funchal OM", url = "http://centova.radio.com.pt:9422/stream"},
    ...
    {name = "RADAR 97.8 FM", url = "https://proic1.evspt.com/radar_aac"},
    ...
    {name = "Rádio Clube Madeira (106.8 FM)", url = "https://audio.serv.pt/8020/stream.mp3"},
    ...
    {name = "Rádio Festival Madeira (98.4 FM)", url = "https://audio.serv.pt/8012/stream.mp3"},
    {name = "Rádio Festival Madeira (98.4 FM)", url = "https://audio.serv.pt/8012/stream.mp3"},
    ...
    {name = "Radio Marginal 98.1 FM", url = "http://centova.radios.pt:8499/stream"},
    ...
    {name = "Rádio Nova 98.9 FM", url = "http://centova.radio.com.pt:9528/"},
    ...
    {name = "Rádio Observador", url = "http://195.23.85.126:8455/stream"},
    ...
    {name = "Rádio Palmeira Madeira (96.1 FM)", url = "https://audio.serv.pt/8018/stream.mp3"},
    {name = "Rádio Paralelo", url = "https://radio.indymedia.pt:8443/main.ogg"},
    {name = "Rádio Pico", url = "http://centova.radios.pt:9420/stream"},
    {name = "Rádio Planície - 92.8 FM", url = "http://109.71.41.6:8026/stream"},
    {name = "Rádio Planície 92.8 Moura", url = "http://109.71.41.6:8026/stream"},
    ...
    {name = "Rádio Popular Madeira (101.0 FM)", url = "https://audio.serv.pt/8018/stream.mp3"},
    ...
    {name = "Rádio RCS 91.2 FM", url = "http://centova.radio.com.pt:8445/stream"},
    ...
    {name = "Rádio Renascença", url = "http://27823.live.streamtheworld.com:3690/RADIO_RENASCENCA_SC"},
    {name = "Rádio Renascença", url = "https://23563.live.streamtheworld.com/RADIO_RENASCENCAAAC.aac"},
    ...
    {name = "Rádio Sol Madeira (103.7 FM)", url = "https://audio.serv.pt/8010/stream.mp3"},
    ...
    {name = "Rádio Vida FM 97.1", url = "http://centova.radio.com.pt:9482/;"},
    ...
    {name = "Rádio Zarco Madeira (89.6 FM)", url = "https://audio.serv.pt/8014/stream.mp3"},
    {name = "Rádio Zig Zag", url = "https://streaming-live.rtp.pt/liveradio/zigzag80a/playlist.m3u8"},
    {name = "Rap/Hip Hop", url = "http://185.32.188.17:8097/stream"},
    ...
    {name = "res fm", url = "https://stream2.soundflux.eu:8440/stream"},
    ...
    {name = "SBSR.FM", url = "http://centova.radio.com.pt:8435/"},
    ...
    {name = "Tropical FM 95.3", url = "https://solid24.streamupsolutions.com/proxy/dcofieen?mp=/stream"},
    {name = "TROPICAL FM 95.3 LISBOA", url = "https://solid24.streamupsolutions.com/proxy/dcofieen?mp=/stream"},
    ...
    {name = "VFM 94.6", url = "http://cast.redewt.net:9141/live"},
