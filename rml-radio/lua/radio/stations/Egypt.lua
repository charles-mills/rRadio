local stations = {
    ...
    {name = "القران الكريم من القاهره", url = "http://n06.radiojar.com/8s5u5tpdtwzuv?rj-ttl=5&amp=&amp=&autoplay=1%22%20type%3D%22audio%2Fmpeg&rj-tok=AAABkZCFW8UAU3ZZmRuFqJa8hw"},
    {name = "القران الكريم من القاهره1", url = "http://n0a.radiojar.com/8s5u5tpdtwzuv?rj=&rj-ttl=5&rj-tok=AAABkZB7VdUA63fhDZmIHBndeg"},
