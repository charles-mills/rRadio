local stations = {
    ...
    {name = ".Al quran radio ", url = "http://n02.radiojar.com/0tpy1h0kxtzuv?rj-ttl=5&rj-tok=AAABkY8lHlUARS_76_SuJXH0vQ"},
    ...
    {name = "Engelliler radyo", url = "https://stream-157.zeno.fm/iuqovax9ftsvv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJpdXFvdmF4OWZ0c3Z2IiwiaG9zdCI6InN0cmVhbS0xNTcuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6IktqbGl5R2tDU29TMzBpSXNQWDRpMnciLCJpYXQiOjE3MjQ2NTk4NzcsImV4cCI6MTcyNDY1OTkzN30.2G5DHeV2pbydrEpW4tzj2VxDs-0plfqMBffGXH__nUI"},
    ...
    {name = "Gri Balkon", url = "http://176.9.113.180:8762/stream"},
    ...
    {name = "Joy Fm", url = "http://28033.live.streamtheworld.com:3690/JOY_FMAAC_SC"},
    ...
    {name = "retro turk", url = "http://25533.live.streamtheworld.com/RETROTURKAAC_SC"},
    ...
    {name = "Show radio ", url = "https://moondigitaledge.radyotvonline.net/show/playlist.m3u8"},
    {name = "SIZIR FM", url = "http://n10.radiojar.com/tamm1f7kk48uv?rj-ttl=5&rj-tok=AAABkY7pxjsAfOBfWdooLI7mAA"},
    ...
    {name = "Süper Fm", url = "https://27993.live.streamtheworld.com:443/SUPER2_SC"},
    {name = "SUPER FM 2 TURKEY", url = "https://25483.live.streamtheworld.com:443/SUPER2_SC?/"},
    ...
    {name = "Virgin Radio Türkiye", url = "http://22673.live.streamtheworld.com:3690/VIRGIN_RADIO_SC"},
    {name = "X Radio", url = "https://stream.xradio.com.tr:8770/stream"},
    {name = "X Radio", url = "https://stream.xradio.com.tr:8770/stream"},
    {name = "X Radio", url = "http://stream.xradio.com.tr:8770/"},
    {name = "X Radio", url = "http://server.gitassi.com:8770/stream"},
    ...
    {name = "اذاعة القرآن الكريم 🇹🇷", url = "http://n07.radiojar.com/0tpy1h0kxtzuv?rj-ttl=5&rj-tok=AAABkY9rnjUAeZ4HolTsNDTHjw"},
}
