...
local alpha = math.Clamp(255 * (1 - (distance - HUD.FADE_DISTANCE.START) / (HUD.FADE_DISTANCE.END - HUD.FADE_DISTANCE.START)), 0, 255)
...
self.anim.textOffset = Lerp(dt * HUD.ANIMATION.SPEED, self.anim.textOffset, math.sin(CurTime() * 2) * HUD.ANIMATION.BOUNCE)
end
...
draw.SimpleText(clippedText, "BoomboxHUD", textX, y + height / 2, ColorAlpha(HUD.COLORS.TEXT, alpha * self.anim.statusTransition), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end
