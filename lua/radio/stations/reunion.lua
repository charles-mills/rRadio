local stations = {
    ...
    {name = [[NRJ Réunion 100,0 FM]], url = [[http://185.52.127.131/fr_re/55759/mp3_128.mp3?adws_out_2&access_token=5910885f7e814a128778aafdad302f47]]},
    {name = [[Radio Babouk]], url = [[https://listen.radioking.com/radio/244351/stream/288496]]},
    {name = [[Réunion La 1Ère]], url = [[https://reunion.ice.infomaniak.ch/reunion-128.mp3]]},
}
