local stations = {
    ...
    {name = "Antena Sur 90.3 FM", url = "https://stream.zeno.fm/tu63bf6g31zuv"},
    ...
    {name = "Corporación Radial E&L - Ocalli, Luya", url = "https://stream.zeno.fm/ve5kqm6deq3vv"},
    ...
    {name = "Estudio J 97.3 FM", url = "https://stream.zeno.fm/qusmdw24a48uv"},
    ...
    {name = "JVM la Estación (Cusco)", url = "https://stream.laut.fm/jvmlaestacion"},
    ...
    {name = "RADIO  PLATINUM  102.9  FM", url = "http://stream.zeno.fm/59sn98mhanruv.pls"},
    ...
    {name = "Radio A 94.9", url = "https://stream.zeno.fm/qxsaiqu7pn4tv"},
    ...
    {name = "Radio Corazón (94.3 FM Lima)", url = "https://mdstrm.com/audio/5fada514fc16c006bd63370f/icecast.audio"},
    ...
    {name = "Radio Felicidad 88.9", url = "https://mdstrm.com/audio/5fad731fcf097a068af3c8f7/icecast.audio"},
    ...
    {name = "Radio La Inolvidable (OBT-4C, 93.7 MHz FM, Lima)", url = "http://provisioning.streamtheworld.com/pls/CRP_LI.pls"},
    ...
    {name = "Radio la Poderosa 98.2 FM _ Lima _ Perú", url = "http://stream.zeno.fm/8dppgdapxneuv"},
    ...
    {name = "Radio La Zona (90.5 FM, Lima)", url = "https://mdstrm.com/audio/5fada54116646e098d97e6a5/icecast.audio"},
    ...
    {name = "Radio Mágica 88.3 FM (OCX-4G, Lima, Perú)", url = "http://playerservices.streamtheworld.com/pls/MAG_AAC.pls"},
    ...
    {name = "RADIO MEGA MIX 96.7 FM Perú", url = "https://mdstrm.com/audio/5fada56fe4e09508207a7951/icecast.audio"},
    ...
    {name = "RADIO MIX 103.5", url = "http://stream.zeno.fm/ug8papw4nbruv"},
    {name = "RADIO MODA 97.3 FM (PERU)", url = "https://25063.live.streamtheworld.com/CRP_MOD_SC?"},
    {name = "Radio Moda FM 97.3", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/CRP_MODAAC.aac"},
    ...
    {name = "Radio Nueva Q (OCZ-4P, 107.1 MHz, Lima)", url = "http://playerservices.streamtheworld.com/pls/CRP_NQ.pls"},
    ...
    {name = "Radio Planeta (OCZ-4L, 107.7 MHz FM, Lima)", url = "http://playerservices.streamtheworld.com/pls/CRP_PLA.pls"},
    {name = "Radio Planeta 107.7", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/CRP_PLAAAC.aac?csegid=1010&dist=1010&_=928052"},
    ...
    {name = "Radio Sotelo (Ancash, Llamellín) 101.3 fm", url = "https://stream.zenolive.com/unde9yxcyzzuv"},
    ...
    {name = "Radio Zona Privada Tacna 96.7", url = "https://stream-42.zeno.fm/mmdbr61v1qruv"},
    ...
    {name = "Radiomar Plus 106.3 Lima", url = "http://playerservices.streamtheworld.com/m3u/CRP_MARAAC.m3u"},
    ...
    {name = "Rock and Pop Classics", url = "https://stream.zeno.fm/kusrlthtbhltv"},
    {name = "Rock&Pop", url = "http://stream.zeno.fm/0k6va3rg8rhvv"},
    ...
    {name = "sikodark", url = "https://stream.zeno.fm/3ungez6rvy8uv"},
    ...
    {name = "Studio 92 (92.5 FM Lima)", url = "https://mdstrm.com/audio/5fada553978fe1080e3ac5ea/icecast.audio"},
