local stations = {
    {name = "Bon FM 102.7  Riscado", url = "http://bonfm5.primcast.com:6482/;"},
    ...
    {name = "Mega Hit FM 101.1", url = "http://megaspice.primcast.com:5216/"},
    {name = "Non Stop Hits Alex FM", url = "https://radioalexfm.stream.laut.fm/radioalexfm?ref=web-app&start_time=1709718045653"},
    {name = "Radio Transmundial Bonaire 800 Khz", url = "https://cdn.instream.audio/:9050/stream"},
    ...
    {name = "Voz di Bonaire 94.7 - Riscado", url = "http://159.203.190.86:8304/;stream.mp3"},
}
