local stations = {
    ...
    {name = "Classic 21 Blues", url = "http://radios.rtbf.be/wr-c21-blues-128.mp3"},
    {name = "Classic 21 Blues", url = "https://radios.rtbf.be/wr-c21-blues-128.mp3"},
    ...
    {name = "Joe", url = "https://streams.radio.dpgmedia.cloud/redirect/joe_fm/aac"},
    ...
    {name = "Ketnet Hits", url = "http://icecast.vrtcdn.be/ketnetradio-high.mp3"},
    ...
    {name = "Komilfoo FM - 106.9 FM Aarschot", url = "http://www.komilfoo.be/live/komilfoo.m3u"},
    ...
    {name = "Musiq3 Jazz", url = "https://radios.rtbf.be/wr-m3-baroque-128.mp3"},
    ...
    {name = "Ocean Waves (myNoise Radio)", url = "http://oceanwaves.radio.mynoise.net/"},
    ...
    {name = "Radio Campus Bruxelles 92.1", url = "https://www.radiocampus.be/stream/stream.aacplus.m3u"},
    {name = "Radio Campus BXL 92.1 [AAC+]", url = "https://www.radiocampus.be/stream/stream.aacplus.m3u"},
    {name = "Radio Campus BXL 92.1 [AAC+]", url = "https://www.radiocampus.be/stream/stream.aacplus.m3u"},
    ...
    {name = "Radio Internazionale", url = "http://ice07.fluidstream.net:8080/fluid713.aac.m3u"},
    ...
    {name = "Radio Sud", url = "https://streaming.domainepublic.net/radiosud.ogg.m3u"},
    ...
    {name = "Radio Utopia 107.9 - Baal, Be", url = "http://panel.beheerstream.com:2199/tunein/radioutopia.pls"},
    ...
    {name = "Rainy Day (myNoise Radio)", url = "http://rainyday.radio.mynoise.net/"},
    ...
    {name = "RTBF Classic 21", url = "https://radios.rtbf.be/classic21-64.aac"},
    ...
    {name = "stubru_untz-high.mp3 ", url = "http://icecast.vrtcdn.be/stubru_untz-high.mp3"},
    {name = "Studio Brussel", url = "http://icecast.vrtcdn.be/stubru-high.mp3"},
    {name = "Studio Brussel", url = "http://icecast.vrtcdn.be/stubru-high.mp3"},
    {name = "Studio Brussel - De Tijdloze", url = "http://icecast.vrtcdn.be/stubru_tijdloze-high.mp3"},
    {name = "Studio Brussel -Vuurland", url = "http://icecast.vrtcdn.be/stubru_tgs-high.mp3"},
    {name = "Studio Brussel (aac)", url = "http://icecast.vrtcdn.be/stubru.aac"},
    ...
    {name = "Tip!k", url = "https://radios.rtbf.be/pure-128.mp3"},
    ...
    {name = "Versuz", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/TOPVERSUZ.mp3"},
    ...
    {name = "VRT Radio 1", url = "http://icecast.vrtcdn.be/radio1-high.mp3"},
    {name = "VRT Radio 1  - De LageLandenLijst", url = "http://icecast.vrtcdn.be/radio1_lagelanden-high.mp3"},
    ...
    {name = "VRT Studio Brussel - De Tijdloze", url = "http://icecast.vrtcdn.be/stubru_tijdloze-high.mp3"},
    ...
    {name = "Willy", url = "https://streams.radio.dpgmedia.cloud/redirect/willy_be/aac"},
    ...
    {name = "Zen Garden (myNoise Radio)", url = "http://zengarden.radio.mynoise.net/"},
