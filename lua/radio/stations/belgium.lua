local stations = {
    ...
    {name = "Instrumentals Forever [AAC 64 Kbit]", url = "https://quincy.torontocast.com:1925/stream"},
    ...
    {name = "Studio Grensstad", url = "https://stream3.mfmstreaming.nl:2390/stream"},
    ...
    {name = "Topradio Best Club Music", url = "https://27993.live.streamtheworld.com/TOPVERSUZ.mp3"},
    ...
    {name = "Xbeat", url = "https://radio.xbeat.org/stream1"},
