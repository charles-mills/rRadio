local stations = {
    ...
    {name = "Rádio Nevasca 104.1 FM", url = "https://cast2.youngtech.radio.br/radio/8110/radio"},
    ...
    {name = "Rock&Pop Perú", url = "http://stream.zeno.fm/0k6va3rg8rhvv"},
    ...
    {name = "rrr", url = "https://www.tdtchannels.com/lists/radio.m3u8"},
    ...
    {name = "test", url = "https://streaming.shoutcast.com/synchronizeradio?"},
    {name = "twst", url = "https://lounge-radio.com/aacplus.m3u"},
