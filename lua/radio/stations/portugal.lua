local stations = {
    ...
    {name = "Rádio Observador", url = "https://27993.live.streamtheworld.com:443/OBSERVADORAAC.aac?dist=web-popup&devicename=aac"},
    ...
    {name = "Rádio Renascença", url = "http://27823.live.streamtheworld.com:80/RADIO_RENASCENCA.mp3"},
