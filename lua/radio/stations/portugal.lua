local stations = {
    ...
    {name = [[Mega Hits]], url = [[http://22533.live.streamtheworld.com:3690/MEGA_HITS_SC]]},
    ...
    {name = [[Rádio Observador]], url = [[https://27873.live.streamtheworld.com:443/OBSERVADORAAC.aac?dist=web-popup&devicename=aac]]},
