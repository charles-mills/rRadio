local stations = {
    ...
    {name = "jovembsk", url = "https://stream-42.zeno.fm/ppgb4k7vhqztv?zs=c_kj97VBTyuKVVdB2EEdEg"},
    ...
    {name = "JOVEMBSK MIX", url = "http://stream.zeno.fm/4nc1mzdp81xuv"},
    {name = "KLBS", url = "https://www.klbs.com/stream.asx"},
    ...
    {name = "Rádio Observador", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/OBSERVADORAAC.aac?dist=web-popup&devicename=aac"},
    ...
    {name = "Rádio Renascença", url = "http://playerservices.streamtheworld.com/api/livestream-redirect/RADIO_RENASCENCA.mp3"},
    ...
    {name = "RFM", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/RFMAAC_SC"},
