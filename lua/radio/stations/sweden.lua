local stations = {
    ...
    {name = [[Liveatc ESSL Twrappcontrol]], url = [[http://s1-bos.liveatc.net:80/essl?nocache=2024082815245823938]]},
    ...
    {name = [[NRJ Sweden]], url = [[http://edge-bauerse-01-gos2.sharp-stream.com/nrj_instreamtest_se_mp3?]]},
    ...
    {name = [[Polushon]], url = [[http://whsh4u-clients.com:9389/stream]]},
    ...
    {name = [[Radio Laholm]], url = [[http://stream-153.zeno.fm/tf8vczzxrg0uv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJ0Zjh2Y3p6eHJnMHV2IiwiaG9zdCI6InN0cmVhbS0xNTMuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6ImlELUZqdEpfVDdlaTVWNEdrU0JoQnciLCJpYXQiOjE3MjQ4NTM0NzEsImV4cCI6MTcyNDg1MzUzMX0.Pq0GEXqZjCQgWIjDnB6sgtZIykDtTMuSmPYdbId5FR8]]},
    ...
    {name = [[Stockholm FM 101,1 Sweden]], url = [[http://radiostreamtwo.sytes.net:18020/]]},
    {name = [[Stockholm FM 1011 Mhz Sweden]], url = [[http://live.narradio.se:8030/;stream.mp3]]},
    {name = [[Stockholm FM 88,0 Sweden]], url = [[http://radiostreamtwo.mine.nu/18000]]},
