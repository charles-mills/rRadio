local stations = {
    {name = [[Mooz Dance TV - Sunet ONLINE By Romaniaradioro]], url = [[http://109.103.178.66:8018/]]},
    ...
    {name = [[Blues Radio]], url = [[http://stream-171.zeno.fm/bpn1hy0h6ehvv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJicG4xaHkwaDZlaHZ2IiwiaG9zdCI6InN0cmVhbS0xNzEuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6IngwZ2FSNXpwUlptMTlCTjJPcUVCdWciLCJpYXQiOjE3MjQ4NTk2ODQsImV4cCI6MTcyNDg1OTc0NH0.gDtn6DCwZ3nRQdhKl-0VNM6Ba2aeZWrvHHVQiiLmzq8]]},
    ...
    {name = [[Dejavumusic]], url = [[https://stream-171.zeno.fm/mdupctf7zxhvv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJtZHVwY3RmN3p4aHZ2IiwiaG9zdCI6InN0cmVhbS0xNzEuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6InotdklqMjVzUi1tMktEVVd6dlppY2ciLCJpYXQiOjE3MjQ4NjE5NzAsImV4cCI6MTcyNDg2MjAzMH0.c0EnCqlCMwS-CAFtkcpmhP1nfIeMj223cNR7enFRhcc]]},
    ...
    {name = [[HIT FM Alba]], url = [[https://s3.myradiostream.com/:4404/listen.mp3?nocache=1724859263]]},
    ...
    {name = [[Nova 22]], url = [[https://s2.myradiostream.com:4520/listen.mp3?nocache=1724861384]]},
    ...
    {name = [[Radio Lumina 904]], url = [[http://live.radiolumina.ro:9000/]]},
    ...
    {name = [[Radio Renaaterea Cluj]], url = [[http://5.2.193.15:8000/live]]},
