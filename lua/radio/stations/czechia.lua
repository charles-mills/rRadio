local stations = {
    ...
    {name = [[Азат Еуропа Азаттық Радиосы RFERL In Kazakh, Ch 11]], url = [[http://n03.radiojar.com/s4r86napn3quv?rj-ttl=5&rj-tok=AAABkZlhRI0A6r3d8zqYuf6_Eg]]},
    ...
    {name = [[Rock Radio]], url = [[https://25683.live.streamtheworld.com:443/ROCK_RADIO_128.mp3]]},
