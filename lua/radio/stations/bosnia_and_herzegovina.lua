local stations = {
    {name = [[Radio Teanj 922Mhz]], url = [[http://radio.daj.ba:8082/stream]]},
    {name = [[1021 TUZLA FM]], url = [[https://canli.arabeskinmerkezi.com/9180/stream]]},
    {name = [[Radio DA]], url = [[http://158.69.119.6:8095/;&type=mp3]]},
    {name = [[Radiopostaja Mir - Meugorje]], url = [[https://mirm.live/mir.mp3]]},
    {name = [[Antena Radio, Jelah Teanj]], url = [[https://radio.tnt.ba/radio/8020/live?1616060583]]},
    ...
    {name = [[Bet Radio Gradaac]], url = [[http://65.108.120.179:8748/stream]]},
    ...
    {name = [[Big Radio 4 Domaica]], url = [[http://domacica.bigportal.ba:8100/domacica]]},
    ...
    {name = [[HIT Radio Brko]], url = [[http://51.254.61.148:8152/;autostart=1]]},
    ...
    {name = [[Kupreki Radio]], url = [[http://178.209.2.100:10000/live.mp3]]},
    ...
    {name = [[Novi Radio Biha]], url = [[https://webtvstream.bhtelecom.ba/novi_radio_bihac.m3u8]]},
    ...
    {name = [[Radio ASK Ilida]], url = [[https://webtvstream.bhtelecom.ba/radio_ask.m3u8]]},
    ...
    {name = [[Radio Biha]], url = [[http://radiobihaclive.radioca.st:8249/stream]]},
    {name = [[Radio Biha Caffe]], url = [[http://5.9.13.39:8075/stream]]},
    {name = [[Radio Biha Folk]], url = [[http://5.9.13.39:8071/stream]]},
    ...
    {name = [[Radio Busovaa]], url = [[https://ec2s.crolive.com.hr:1510/stream]]},
    {name = [[Radio Apljina]], url = [[http://s8.iqstreaming.com:8016/]]},
    ...
    {name = [[Radio Dungla Doboj]], url = [[http://5.9.25.50:9302/stream]]},
    {name = [[Radio Dungla Doboj 2]], url = [[http://cast2.name.ba:9054/]]},
    {name = [[Radio Dungla Doboj 3]], url = [[http://cast2.name.ba:8006/]]},
    ...
    {name = [[Radio Gorade]], url = [[https://webtvstream.bhtelecom.ba/radio_gorazde.m3u8]]},
    {name = [[Radio Graanica]], url = [[https://webtvstream.bhtelecom.ba/radio_gracanica.m3u8]]},
    {name = [[Radio Gradaac]], url = [[https://webtvstream.bhtelecom.ba/radio_gradacac.m3u8]]},
    ...
    {name = [[Radio Klju]], url = [[http://195.222.33.217:8093/;]]},
    {name = [[Radio Konjic]], url = [[https://webtvstream.bhtelecom.ba/radio_konjic.m3u8]]},
    {name = [[Radio Ljubuki]], url = [[https://s8.iqstreaming.com:8044/stream]]},
    ...
    {name = [[Radio Oraje]], url = [[http://188.40.62.20:8024/]]},
    {name = [[Radio Posavina Zagreb]], url = [[http://cmr-hosting.com:8500/;stream.mp3]]},
    {name = [[Radio Postaja Odak]], url = [[https://stream3.rcast.net/70602]]},
    {name = [[Radio Posuje]], url = [[http://136.243.144.93:9994/]]},
    {name = [[Radio Praa]], url = [[https://webtvstream.bhtelecom.ba/radio_praca.m3u8]]},
    ...
    {name = [[Radio Vogoa]], url = [[https://webtvstream.bhtelecom.ba/radio_vogosca.m3u8]]},
