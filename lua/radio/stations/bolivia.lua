local stations = {
    ...
    {name = "Coral FM 96.7 La del Sabor", url = "https://stream.zeno.fm/7yetzvv8sm0uv"},
    ...
    {name = "Hit 105.7 FM", url = "https://stream-175.zeno.fm/u7ixfizasppvv?zs=hOeDNX_iSJaUUl90gnwQfQ"},
    ...
    {name = "Oxígeno 107.5 FM", url = "https://stream-160.zeno.fm/up7we7qvsg0uv?zs=gjBe9XCDQEOMJM1x8F8W1A"},
    ...
    {name = "Radio Continental 99.7 FM", url = "https://stream-154.zeno.fm/bdnz2z7rnwzuv?zs=E1YbP0AVR4KD_2mbCSafsQ"},
    {name = "Radio Cumbia 90s", url = "https://emiteradio.com/proxy/cumbia90s?mp=/stream"},
    {name = "Radio Disney - La Paz FM 102.7", url = "https://playerservices.streamtheworld.com/api/livestream-redirect/DISNEY_BOL_SCAAC.aac?dist=web-radiodisney"},
    ...
    {name = "Radio Porvenir 107.1  FM", url = "https://stream-162.zeno.fm/qmygszenzhhvv?zs=UxWnTDLES_Wyuus3XtXJRQ"},
    {name = "Radio Potencia Dinámica 95.8 FM", url = "https://stream-174.zeno.fm/k0pzxa1u1f8uv?zs=gU6PWbIXRUyu8V5zLdjTRg"},
