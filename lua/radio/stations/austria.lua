local stations = {
    ...
    {name = "Antenne Österreich", url = "https://frontend.streamonkey.net/antoesterreich-live"},
    ...
    {name = "Atnnene sSterewich", url = "https://frontend.streamonkey.net/antoesterreich-live"},
    ...
    {name = "Austrian Rock Radio", url = "http://live.antenne.at/arr"},
    {name = "Austrian Rock Radio", url = "http://live.antenne.at/arr"},
    {name = "AustrianKultRadio", url = "https://stream.zeno.fm/c6e7ttwg0aqtv"},
    ...
    {name = "DrumandBass.FM", url = "http://stream.laut.fm/drumandbass_fm"},
    ...
    {name = "Jö.Live", url = "https://live.stream.maxfive.com/max5-joelive"},
    ...
    {name = "Life Radio Kuschelrock", url = "https://stream.liferadio.at/kuschelrock/aac-128/stream.liferadio.at/"},
    ...
    {name = "Life Radio Tirol", url = "https://stream.liferadio.tirol/live/mp3-192/link"},
    ...
    {name = "NRJ.at - Pop", url = "http://cdn.nrjaudio.fm/adwz1/at/36063/aac_64.mp3"},
    ...
    {name = "ORF Hitradio Ö3", url = "https://orf-live.ors-shoutcast.at/oe3-q2a.m3u"},
    ...
    {name = "ORF Radio Kärnten", url = "https://orf-live.ors-shoutcast.at/ktn-q2a.m3u"},
    ...
    {name = "ORF Radio Wien", url = "http://orf-live.ors-shoutcast.at/wie-q2a.m3u"},
    {name = "ORF Radio Wien", url = "https://orf-live.ors-shoutcast.at/wie-q2a.m3u"},
    ...
    {name = "radio 88.6", url = "http://radio886.at/streams/radio_88.6/mp3"},
    {name = "radio 88.6", url = "https://radio886.at/streams/88.6_On_Air/radio_at_de_net/auto88.6"},
