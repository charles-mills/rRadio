local stations = {
    ...
    {name = "Wadata Radio 1074 Niamey", url = "http://stream.zeno.fm/1y2c3qbgbchvv"},
    ...
    {name = "Radio Dallol 928 Dogondoutchi", url = "https://stream.zeno.fm/orv3efzpotytv"},
    ...
    {name = "Radio Moubarak 911 Ouallam", url = "https://stream.zeno.fm/ocexarwh8o8tv"},
}
