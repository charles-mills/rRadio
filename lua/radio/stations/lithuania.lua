local stations = {
    ...
    {name = "M-1", url = "http://www.radijas.fm/media/_catalog/www.radijas.fm-radijo-stotis-m-1.pls"},
    ...
    {name = "PMR", url = "https://pmr.lt/streams/pmr.m3u"},
    {name = "pmr.lt - world music radio", url = "http://pmr.lt/streams/pmr-1"},
