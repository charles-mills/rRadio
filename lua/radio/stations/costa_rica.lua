local stations = {
    ...
    {name = [[La Caliente 907 FM]], url = [[https://27433.live.streamtheworld.com:443/QTEJA_CRAAC_SC]]},
    ...
    {name = [[Radio Omega 1051 FM]], url = [[https://centova.hostingtico.com:7008/;]]},
    ...
    {name = [[Radio Revolución]], url = [[https://stream-172.zeno.fm/ftcx2988uwzuv?zt=eyJhbGciOiJIUzI1NiJ9.eyJzdHJlYW0iOiJmdGN4Mjk4OHV3enV2IiwiaG9zdCI6InN0cmVhbS0xNzIuemVuby5mbSIsInJ0dGwiOjUsImp0aSI6ImlpZDdkdVprU05lTjJRMzl6bVdGN2ciLCJpYXQiOjE3MjQ4NjIxNjQsImV4cCI6MTcyNDg2MjIyNH0.4L1QMmqJRBj6D2nvVD9d2Vd1DpJ6uCGNySm_owCYUn8]]},
