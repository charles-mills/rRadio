local stations = {
    ...
    {name = [[Caltexmusic]], url = [[http://n11.radiojar.com/cp13r2cpn3quv?rj-ttl=5&rj-tok=AAABkZmtuA8APdN73ZbmNb72JQ]]},
    ...
    {name = [[Iran International HTTPS Stream]], url = [[http://n01.radiojar.com/iintl_c?rj-ttl=5&rj-tok=AAABkZmg_60A-8gJOJYnTByooA]]},
