local stations = {
    ...
    {name = "CBS  표쥰 FM 98.1MHz", url = "http://aac.cbs.co.kr/cbs981/_definst_/cbs981.stream/playlist.m3u8"},
    ...
    {name = "Clasico kbs", url = "http://serpent0.duckdns.org:8088/kbsfm.pls"},
    ...
    {name = "Floyd Server (Rock Ballad...From 09/25/05)", url = "http://1.uicl.co.kr:8000/;"},
    {name = "Fred Film Radio(한국어)", url = "https://s10.webradio-hosting.com/proxy/fredradiokr/stream"},
    {name = "GFN 98.7 FM", url = "http://218.157.19.198:8000/;stream/1"},
    ...
    {name = "Gwangju Foreign Language Network 98.7 - English", url = "http://218.157.19.198:8000/"},
    {name = "http://211.221.46.79:1935/live/mp4:BusanMBC.Live-FM-0415/playlist.m3u8", url = "http://211.221.46.79:1935/live/mp4:BusanMBC.Live-FM-0415/playlist.m3u8"},
    ...
    {name = "KBS 1Radio", url = "http://serpent0.duckdns.org:8088/kbs2radio.pls"},
    {name = "KBS Classic FM", url = "https://zstream.win/pls/kbs_1fm.pls"},
    ...
    {name = "KBS Classic FM", url = "http://serpent0.duckdns.org:8088/kbsfm.pls"},
    {name = "KBS Classic FM", url = "http://serpent0.duckdns.org:8088/kbsfm.pls"},
    {name = "kbs classic fm", url = "http://serpent0.duckdns.org:8088/kbs1fm.pls"},
    {name = "KBS Classic FM", url = "http://serpent0.duckdns.org:8088/kbsfm.pls"},
    ...
    {name = "KBS_kor", url = "http://serpent0.duckdns.org:8088/kbs1radio.pls"},
    ...
    {name = "Listen.moe (K-Pop)", url = "https://listen.moe/kpop/fallback"},
    {name = "Listen.moe Kpop", url = "https://listen.moe/kpop/stream"},
    {name = "Listen.Moe KPop Vorbis", url = "https://listen.moe/kpop/stream"},
    {name = "MBC FM", url = "http://serpent0.duckdns.org:8088/mbcsfm.pls"},
    {name = "MBC FM for you", url = "http://serpent0.duckdns.org:8088/mbcfm.pls"},
    ...
    {name = "Pinoy Seoul Radio 101.3 FM", url = "https://securestreams.autopo.st:1215/stream"},
    ...
    {name = "안동MBC FM4U", url = "https://live.andongmbc.co.kr/live/fmlive/playlist.m3u8"},
