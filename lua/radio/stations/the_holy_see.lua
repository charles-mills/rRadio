local stations = {
    ...
    {name = "Radio Vaticana Belarus", url = "https://radio.vaticannews.va/stream-be"},
    {name = "Radio Vaticana România", url = "https://radio.vaticannews.va/stream-ro"},
    {name = "Radio Vaticana Polska", url = "https://radio.vaticannews.va/stream-pl"},
    {name = "Radio Vaticana Bulgaria", url = "https://radio.vaticannews.va/stream-bg"},
    ...
    {name = "Rádio Vaticano Português", url = "https://www.radios.com.br/play/playlist/9130/listen-radio.m3u"},
}
