...
hook.Add(
    ...
    "RadioVehicleHandling",
    function(ply, vehicle)
        local veh = utils.GetVehicle(vehicle)
        if not veh then
            return
        end
...
hook.Add(
    "EntityRemoved",
    "CleanupActiveRadioOnEntityRemove",
    function(entity)
...
hook.Add(
    "InitPostEntity",
    "LoadPermanentBoomboxesOnServerStart",
    function()
        timer.Simple(
            0.5,
            function()
...
hook.Add(
    "InitPostEntity",
    "EnsureActiveRadioFunctionAvailable",
    function()
